...
class TestBigStepEval extends funsuite.AnyFunSuite {
    ...
    test("big step eval: const should be evaluated to const") {
    ...
    test("big step eval: identity function should be returning the same value ") {
    ...
    test("big step eval: factorial 3 should be 6") {
